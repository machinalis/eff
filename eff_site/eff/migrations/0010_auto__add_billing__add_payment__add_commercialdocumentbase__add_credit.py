...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('eff_billing', (
            ('commercialdocumentbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['eff.CommercialDocumentBase'], unique=True, primary_key=True)),
        ...
        # Adding model 'CommercialDocumentBase'
        db.create_table('eff_commercialdocumentbase', (
        ...
        db.send_create_signal('eff', ['CommercialDocumentBase'])
        ...
        db.alter_column('eff_project', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))
    def backwards(self, orm):
        ...
        # Deleting model 'CommercialDocumentBase'
        db.delete_table('eff_commercialdocumentbase')
        ...
        # Changing field 'Project.end_date'
        db.alter_column('eff_project', 'end_date', self.gf('django.db.models.fields.DateField')())
    models = {
        'auth.group': {
