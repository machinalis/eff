...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for project in orm.Project.objects.all():
            tm = orm.TimeLog.objects.filter(project=project).order_by('date')
            if tm:
                project.start_date = tm[0].date
            else:
    ...
    models = {
        ...
        'eff.project': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eff.Client']"}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': "'2000-09-02'", 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'repository': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': "'2000-09-02'"})
        },
        'eff.projectassoc': {
