...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BillingEmail'
        db.create_table('eff_billingemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_address', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('send_as', self.gf('django.db.models.fields.CharField')(default='to', max_length=3)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eff.Client'])),
        ))
        db.send_create_signal('eff', ['BillingEmail'])

    def backwards(self, orm):
        # Deleting model 'BillingEmail'
        db.delete_table('eff_billingemail')
