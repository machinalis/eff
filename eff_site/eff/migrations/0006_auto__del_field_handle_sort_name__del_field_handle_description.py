...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Handle.sort_name'
        db.delete_column('eff_handle', 'sort_name')

        # Deleting field 'Handle.description'
        db.delete_column('eff_handle', 'description')

    def backwards(self, orm):
        # Adding field 'Handle.sort_name'
        db.add_column('eff_handle', 'sort_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Handle.description'
        db.add_column('eff_handle', 'description',
