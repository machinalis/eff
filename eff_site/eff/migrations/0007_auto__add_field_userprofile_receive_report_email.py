...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.receive_report_email'
        db.add_column('eff_userprofile', 'receive_report_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.receive_report_email'
        db.delete_column('eff_userprofile', 'receive_report_email')
