...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('eff_csvlog', 'eff_timelog')
        db.rename_column('eff_timelog', 'time_on_task', 'hours_booked')
        db.rename_column('eff_timelog', 'summary', 'description')

    def backwards(self, orm):
        db.rename_table('eff_timelog', 'eff_csvlog')
        db.rename_column('eff_csvlog', 'hours_booked', 'time_on_task')
        db.rename_column('eff_csvlog', 'description', 'summary')
