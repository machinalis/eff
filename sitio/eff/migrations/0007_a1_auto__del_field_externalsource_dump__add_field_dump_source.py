...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dump.source'
        db.add_column('eff_dump', 'source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eff.ExternalSource'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ExternalSource.dump'
        #db.add_column('eff_externalsource', 'dump', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['eff.Dump']), keep_default=False)

        # Deleting field 'Dump.source'
        db.delete_column('eff_dump', 'source_id')
