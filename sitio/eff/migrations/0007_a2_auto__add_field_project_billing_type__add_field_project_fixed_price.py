...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.billing_type'
        db.add_column('eff_project', 'billing_type', self.gf('django.db.models.fields.CharField')(default='HOUR', max_length=8), keep_default=False)

        # Adding field 'Project.fixed_price'
        db.add_column('eff_project', 'fixed_price', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.billing_type'
        db.delete_column('eff_project', 'billing_type')

        # Deleting field 'Project.fixed_price'
        db.delete_column('eff_project', 'fixed_price')
