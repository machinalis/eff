...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectAssoc.user_rate'
        db.add_column('eff_projectassoc', 'user_rate', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)
        db.rename_column('eff_projectassoc', 'rate', 'client_rate')
        db.rename_column('eff_projectassoc', 'start_date', 'from_date')
        db.rename_column('eff_projectassoc', 'end_date', 'to_date')


    def backwards(self, orm):
        
        # Deleting field 'ProjectAssoc.user_rate'
        db.delete_column('eff_projectassoc', 'user_rate')
        db.rename_column('eff_projectassoc', 'client_rate', 'rate')
        db.rename_column('eff_projectassoc', 'from_date', 'start_date')
        db.rename_column('eff_projectassoc', 'to_date', 'end_date')
